...
export const en: Translations = {
  ...
  ui: {
    ...
    http_proxy_placeholder: "http://127.0.0.1:7890 (leave empty for direct)",
    harness_launch: "Harness Launch Options",
    dsh_environment: "Environment",
    dsh_arguments: "Arguments",
    name: "Name",
    value: "Value",
    ...
    restore: "Restore",
    close: "Close",
    drag_window: "Drag window, double-click to maximize",
    zoom_level: "Interface zoom: {{level}}%",
    zoom_minimum: "Minimum zoom reached",
    zoom_maximum: "Maximum zoom for this window reached",
